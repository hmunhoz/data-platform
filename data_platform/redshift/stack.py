...
class SpectrumRole(iam.Role):
    def __init__(
        ...
        **kwargs,
        ...
        self.deploy_env = data_lake_silver_bucket.deploy_env
            ...
            statements=[
                ...
                iam.PolicyStatement(
                    ...
                    resources=[
                        ...
                        self.data_lake_gold_bucket.bucket_arn,
                        f"{self.data_lake_gold_bucket.bucket_arn}/*",
                    ],
                ),
            ],
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.redshift_cluster = redshift.Cluster(
            ...
            roles=[
                SpectrumRole(
                    self, self.data_lake_silver_bucket, self.data_lake_gold_bucket
                )
            ],
